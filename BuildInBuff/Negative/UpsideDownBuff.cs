...
{
    internal class UpsideDownBuff : Buff<UpsideDownBuff, UpsideDownBuffData>
    {
    ...
    internal class UpsideDownBuffEntry : IBuffEntry
    {
        ...
        {
            BuffRegister.RegisterBuff<UpsideDownBuff, UpsideDownBuffData, UpsideDownBuffEntry>(UpsideDownID);
        }
